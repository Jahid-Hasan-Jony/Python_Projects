...
cal = Tk()
cal.title('Digital Calculator')
operator=''
text_input =StringVar()

txtDisply= Entry(cal,font=('arial', 20,'bold'), textvariable=text_input, bd=25, insertwidth=4,bg='gray', justify='right').grid(columnspan=4)
